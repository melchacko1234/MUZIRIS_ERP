...
public class Promotion_122_BNGN_Nitems_Exist_cust {
	...
	public class Customer_Mobile_new_Test {
		...
		public void Bill_Settlement_exist_Mobile_cust_promotion122_scan_estimate() throws InterruptedException, IOException

		{
	
			driver.findElement(By.xpath("//input[@name='scanEstimate']")).sendKeys("EKM30820SIE0376");
		...
		//{
...

			{
				...
				driver.findElement(By.xpath("//input[@id='txtCardPayment_amount']")).sendKeys("900.30");
				...
				driver.findElement(By.xpath("//input[@id='txtChequePayment_amount']")).sendKeys("38");
				Thread.sleep(3000);
