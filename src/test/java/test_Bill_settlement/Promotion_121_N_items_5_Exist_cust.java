...
public class Promotion_121_N_items_5_Exist_cust {
	...
	public class Customer_Mobile_new_Test {
		...
		public void Bill_Settlement_exist_Mobile_cust_promotion121_scan_estimate() throws InterruptedException, IOException

		{
	
			driver.findElement(By.xpath("//input[@name='scanEstimate']")).sendKeys("EKM30820SIE0369");
			...
			driver.findElement(By.xpath("//input[@name='genDisc_specialDisRate']")).sendKeys("7");
		...
		//{
			...
			FileUtils.copyFile(scrFile, new File("E:\\MUZIRIS_ERP\\Bill_Settlement\\Promotion_121_Apply.png"));
			Thread.sleep(3000);
			driver.findElement(By.xpath("//button[@id='btnPromotions_Close']")).click();
			...
			Thread.sleep(3000);
			scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			FileUtils.copyFile(scrFile, new File("E:\\MUZIRIS_ERP\\Bill_Settlement\\Promotion_121Billsettlement_Tax.png"));
			...
			public void Bill_Settlement_exist_Mobile_cust_promotion121_card_payment() throws InterruptedException

			{
				...
				driver.findElement(By.xpath("//input[@id='txtCardPayment_amount']")).sendKeys("2650");
				...
				driver.findElement(By.xpath("//input[@id='txtChequePayment_amount']")).sendKeys("100");
				Thread.sleep(3000);
				...
				driver.findElement(By.xpath("(//input[@value='0'])[6]")).sendKeys("2");
