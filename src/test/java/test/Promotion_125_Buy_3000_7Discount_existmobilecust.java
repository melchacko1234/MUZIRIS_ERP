...
public class Promotion_125_Buy_3000_7Discount_existmobilecust extends Invalid_Popup {
	...
	public class Customer_Mobile_new_existingTest_Promotion_125_Buy_300 extends BaseClass  {
		...
		public  void barcode2_promotion125() throws InterruptedException, IOException
		{
			...
			Object [][] arr1=sc.myTest1();
			driver.findElement(By.xpath("//input[@name='scanBarcode']")).sendKeys((String) arr1[27][0]);
		...
		{
			//Object [][] arr1=sc.myTest1();
			//driver.findElement(By.xpath("//input[@name='scanBarcode']")).sendKeys((String) arr1[28][0]);
		...
		public  void promotion125() throws InterruptedException, IOException
		{
			...
			scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			FileUtils.copyFile(scrFile, new File("E:\\MUZIRIS_ERP\\Promotion\\Promtion125\\Sales_Invoice-Estimate_promotion125failed.png"));
			...
			scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			FileUtils.copyFile(scrFile, new File("E:\\MUZIRIS_ERP\\Promotion\\Promtion125\\Sales_Invoice-Estimate_promotion125.png"));
